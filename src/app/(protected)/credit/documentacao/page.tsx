...
import { listarMinhasSolicitacoes, listarDocumentos } from '@/services/credit';
import { SolicitacaoCredito, DocumentoCredito } from '@/types/credit';
import UploadDocumentos from '@/components/credit/UploadDocumentos';
