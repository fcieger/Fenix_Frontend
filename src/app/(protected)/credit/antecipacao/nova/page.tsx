...
import { simularAntecipacao, solicitarAntecipacao } from '@/services/credit';
...
export default function NovaAntecipacaoPage() {
  ...
  const handleConfirmar = async () => {
    ...
    try {
      ...
      router.push('/credit/antecipacao');
    } catch (error: any) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      {/* Header */}
      <div className="mb-6">
        <Link href="/credit/antecipacao" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4">
