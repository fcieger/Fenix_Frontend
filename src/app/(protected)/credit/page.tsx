...
import { listarMinhasSolicitacoes, buscarMeuCapitalGiro } from '@/services/credit';
import { SolicitacaoCredito, CapitalGiro } from '@/types/credit';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Solicitar Crédito */}
        {!temSolicitacaoAtiva && (
          <Link href="/credit/solicitar" className="block">
        ...
        {/* Minhas Solicitações */}
        <Link href="/credit/minhas-solicitacoes" className="block">
        ...
        {/* Propostas */}
        <Link href="/credit/propostas" className="block">
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow border-2 border-gray-200">
        ...
        {/* Capital de Giro */}
        {capitalGiro && (
          <Link href="/credit/capital-giro" className="block">
        ...
        {capitalGiro && (
          <Link href="/credit/antecipacao" className="block">
            <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow border-2 border-gray-200">
