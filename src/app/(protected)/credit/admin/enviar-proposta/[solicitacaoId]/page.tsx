...
import { buscarSolicitacaoAdmin, criarProposta } from '@/services/credit';
import { SolicitacaoCredito, FormEnviarProposta } from '@/types/credit';
...
export default function EnviarPropostaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/credit/admin/propostas');
    } catch (error: any) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      {/* Header */}
      <div className="mb-6">
        <Link href="/credit/admin/propostas" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4">
