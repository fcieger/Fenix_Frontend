...
export default function AlertasPage() {
  ...
  const [editingAlerta, setEditingAlerta] = useState<AlertaLicitacao | null>(
    null
  );
  const [searchTerm, setSearchTerm] = useState("");
  const [filterAtivo, setFilterAtivo] = useState<"all" | "ativo" | "inativo">(
    "all"
  );
  ...
  const handleToggleAtivo = async (alerta: AlertaLicitacao) => {
    try {
      ...
      toast.success(
        `Alerta ${!alerta.ativo ? "ativado" : "desativado"} com sucesso!`
      );
      await carregarAlertas();
    } catch (error: any) {
  ...
  const stats = {
    ...
    tempoReal: alertas.filter((a) => a.frequencia === "tempo_real" && a.ativo)
      .length,
  };
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Receba notificações quando novas licitações corresponderem aos
                seus critérios
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  ...
                  (estados, modalidades, valores, palavras-chave). Quando novas
                  licitações corresponderem aos seus critérios, você receberá
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        variant={
                          filterAtivo === "ativo" ? "default" : "outline"
                        }
                        size="sm"
                      ...
                      <Button
                        variant={
                          filterAtivo === "inativo" ? "default" : "outline"
                        }
                        size="sm"
                              ...
                              <div className="flex items-start gap-2 p-3 rounded-lg bg-gray-50">
                                ...
                                <div className="min-w-0">
                                  ...
                                  <p className="text-sm font-semibold text-gray-900">
                                    {alerta.modalidades.length} selecionada
                                    {alerta.modalidades.length > 1 ? "s" : ""}
                                  </p>
                                </div>
                              </div>
                            )}
                          {(alerta.valorMinimo || alerta.valorMaximo) && (
                            <div className="flex items-start gap-2 p-3 rounded-lg bg-gray-50">
                              ...
                              <div className="min-w-0">
                                ...
                                <p className="text-sm font-semibold text-gray-900">
                                  {alerta.valorMinimo &&
                                    `Min: R$ ${alerta.valorMinimo.toLocaleString(
                                      "pt-BR"
                                    )}`}
                                  {alerta.valorMinimo &&
                                    alerta.valorMaximo &&
                                    " • "}
                                  {alerta.valorMaximo &&
                                    `Max: R$ ${alerta.valorMaximo.toLocaleString(
                                      "pt-BR"
                                    )}`}
                                </p>
                              </div>
