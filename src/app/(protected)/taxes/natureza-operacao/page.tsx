...
export default function NaturezaOperacaoPage() {
      ...
      if (token && activeCompanyId) {
        ...
        console.log(
          ...
          data[0]
            ? {
                nome: data[0].nome,
                frenteDeCaixa: (data[0] as any).frenteDeCaixa,
                considerarOperacaoComoFaturamento:
                  data[0].considerarOperacaoComoFaturamento,
                destacarTotalImpostosIBPT: data[0].destacarTotalImpostosIBPT,
                gerarContasReceberPagar: data[0].gerarContasReceberPagar,
                tipos: {
                  frenteDeCaixa: typeof (data[0] as any).frenteDeCaixa,
                  considerarOperacaoComoFaturamento:
                    typeof data[0].considerarOperacaoComoFaturamento,
                },
              }
            : "Nenhuma natureza"
        );
  ...
  const handleEdit = (id: string) => {
    router.push(`/taxes/natureza-operacao/novo?edit=${id}`);
  };
  ...
  const handleConfigurar = async (id: string) => {
    try {
      ...
      if (configuracoes && configuracoes.length > 0) {
        ...
        router.push(`/taxes/natureza-operacao/${id}/configuracao`);
      } else {
  ...
  const handleNovaNatureza = () => {
    router.push("/taxes/natureza-operacao/novo");
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-50">
        ...
        >
          ...
          <p className="text-purple-600 mt-6 font-medium text-lg">
            Carregando naturezas de operação...
          </p>
      ...
      <div className="relative bg-gradient-to-r from-purple-600 to-indigo-700 rounded-2xl p-8 text-center">
        ...
        >
          ...
          <p className="text-purple-200 text-lg">
            Gerencie as naturezas de operação e configurações fiscais
          </p>
        </motion.div>
      </div>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-sm text-gray-500">
                  {totalNaturezas}{" "}
                  {totalNaturezas === 1 ? "natureza" : "naturezas"}
                </span>
              </div>
            </div>
                        ...
                        >
                            ...
                            <div className="flex items-center">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="text-xs lg:text-sm text-gray-500 flex items-center mt-1">
                                  ...
                                  <span className="hidden lg:inline">
                                    Criado em {formatDate(natureza.createdAt)}
                                  </span>
                                  <span className="lg:hidden">
                                    {
                                      formatDate(natureza.createdAt).split(
                                        " "
                                      )[0]
                                    }
                                  </span>
                          ...
                          <td className="px-3 lg:px-6 py-4 lg:py-6">
                            <div className="flex flex-wrap gap-1 lg:gap-2">
                              {((natureza as any).frenteDeCaixa === true ||
                                (natureza as any).frenteDeCaixa === "true" ||
                                (natureza as any).frenteDeCaixa === 1) && (
                              ...
                              {(natureza.destacarTotalImpostosIBPT === true ||
                                (natureza as any).destacarTotalImpostosIBPT ===
                                  "true") && (
                              ...
                              {(natureza.gerarContasReceberPagar === true ||
                                (natureza as any).gerarContasReceberPagar ===
                                  "true") && (
                              ...
                              {!(
                                ...
                                !(
                                  natureza.destacarTotalImpostosIBPT === true ||
                                  (natureza as any)
                                    .destacarTotalImpostosIBPT === "true"
                                ) &&
                                !(
                                  natureza.gerarContasReceberPagar === true ||
                                  (natureza as any).gerarContasReceberPagar ===
                          ...
                          <td className="px-3 lg:px-6 py-4 lg:py-6 text-center">
                            <div className="flex items-center justify-center space-x-1 lg:space-x-2">
                              ...
                              >
                                <Button
                                  onClick={() =>
                                    setShowDeleteModal(natureza.id)
                                  }
                                  size="sm"
                    ...
                    >
                      ...
                      <div className="mb-3">
                        ...
                        <div className="flex flex-wrap gap-1">
                          ...
                          {((natureza as any)
                            .considerarOperacaoComoFaturamento === true ||
                            (natureza as any)
                              .considerarOperacaoComoFaturamento ===
                              "true") && (
                          ...
                          {((natureza as any).movimentaEstoque === true ||
                            (natureza as any).movimentaEstoque === "true") && (
                            <span className="inline-flex items-center px-2 py-1 rounded text-xs bg-purple-100 text-purple-800">
                              📦 Estoque
                            </span>
              ...
              <div className="mt-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="text-sm text-gray-600 font-medium">
                    ...
                    a{" "}
                    <span className="font-bold text-purple-600">
                      {Math.min(endIndex, totalNaturezas)}
                    </span>{" "}
                    de{" "}
                    <span className="font-bold text-purple-600">
                      {totalNaturezas}
            ...
            <div className="text-center">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                ...
                <p className="text-xs text-red-600 mt-1">
                  A natureza e todas as suas configurações serão permanentemente
                  removidas.
                </p>
              </div>
