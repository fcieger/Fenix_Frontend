...
function NovaConfiguracaoNfeForm() {
  ...
  const [enviarNotificacaoCliente, setEnviarNotificacaoCliente] =
    useState(false);
  ...
  const [configuracaoExistente, setConfiguracaoExistente] =
    useState<ConfiguracaoNfeResponse | null>(null);
  ...
  const naturezasOperacao = [
    ...
    {
      value: "6",
      label: "6 - Exigibilidade suspensa por procedimento administrativo",
    },
  ];
    ...
    const carregarConfiguracao = async () => {
      ...
      try {
        ...
        if (config.tipoModelo) {
          setTipoModelo(config.tipoModelo as any);
        }
  ...
  const handleSalvar = async () => {
    ...
    try {
      ...
      if (isEditMode && configId) {
        await apiService.updateConfiguracaoNfe(
          configId,
          configuracaoData,
          token
        );
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold flex items-center">
                  ...
                  {isEditMode
                    ? "Editar Configuração de NFe"
                    : "Nova Configuração de NFe"}
                </h1>
                <p className="text-purple-100 mt-1 text-sm sm:text-base">
                  Configure os parâmetros para emissão de notas fiscais
                </p>
              </div>
            </div>
          ...
          <div className="p-6">
            ...
            <TabsContent value="rps" className="space-y-6 mt-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label
                    htmlFor="regimeEspecialTributacao"
                    className="text-sm font-semibold text-gray-700"
                  >
                  ...
                  <Select
                    ...
                    onValueChange={setRegimeEspecialTributacao}
                  >
                    <SelectTrigger className="h-11 border-gray-300 focus:ring-purple-500 rounded-lg">
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        setMostrarSenhaPrefeitura(!mostrarSenhaPrefeitura)
                      }
                      className="h-11 px-4 hover:bg-purple-50 border-gray-300 rounded-lg"
                    >
                      {mostrarSenhaPrefeitura ? (
                  ...
                  <div className="flex flex-col space-y-3">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setEnviarNotificacaoCliente(checked === true)
                        }
                      />
                      <Label
                        htmlFor="enviarNotificacaoCliente"
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setReceberNotificacao(checked === true)
                        }
                      />
                      <Label
                        htmlFor="receberNotificacao"
                        className="text-sm font-medium cursor-pointer"
                      >
                        Receber Notificação
                      </Label>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900 mb-1">
                      Informações sobre Token NFC-e
                    </h4>
                    <p className="text-blue-800 text-sm leading-relaxed">
                      O ID Token e CSC (Código de Segurança do Contribuinte) são
                      fornecidos pela SEFAZ para autenticação na emissão de
                      NFC-e. Estes dados são obrigatórios para o funcionamento
                      correto da emissão de notas fiscais de consumidor.
                    </p>
                  </div>
                </div>
              </div>
