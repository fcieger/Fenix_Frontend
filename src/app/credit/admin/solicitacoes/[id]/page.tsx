...
import { buscarSolicitacaoAdmin, aprovarSolicitacao, reprovarSolicitacao } from '@/services/credit';
...
export default function AdminSolicitacaoDetalhePage() {
  ...
  const handleAprovar = async () => {
    ...
    try {
      ...
      router.push('/credit/admin/solicitacoes');
    } catch (error: any) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      {/* Header */}
      <div className="mb-6">
        <Link href="/credit/admin/solicitacoes" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4">
        ...
        <div className="space-y-6">
          ...
          {solicitacao.status === 'aprovado' && (
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
              ...
              <Link
                href={`/credit/admin/enviar-proposta/${solicitacaoId}`}
