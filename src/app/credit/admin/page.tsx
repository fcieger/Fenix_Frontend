...
import { buscarDashboardAdmin } from '@/services/credit';
import { DashboardMetrics } from '@/types/credit';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/credit/admin/solicitacoes" className="block">
        ...
        <Link href="/credit/admin/propostas" className="block">
          <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6 border-2 border-gray-200 hover:border-blue-500">
        ...
        <Link href="/credit/admin/clientes" className="block">
          <div className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow p-6 border-2 border-gray-200 hover:border-blue-500">
