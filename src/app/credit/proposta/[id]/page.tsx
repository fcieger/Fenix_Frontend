...
import { buscarProposta, aceitarProposta, recusarProposta } from '@/services/credit';
...
export default function PropostaDetalhePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      {/* Header */}
      <div className="mb-6">
        <Link href="/credit/propostas" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4">
