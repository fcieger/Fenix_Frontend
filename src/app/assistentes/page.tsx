    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="flex flex-col items-center">
          ...
          <p className="text-purple-600 mt-4 font-medium">Carregando assistentes...</p>
        </div>
      </div>
    );
  }
  ...
  const assistentes = [
    {
      ...
      description: 'Criação inteligente de cadastros de clientes, fornecedores, transportadoras e outros tipos de pessoas/empresas. Extrai automaticamente dados de CNPJ, CPF, endereços e identifica tipos de cadastro.',
      icon: Users,
    ...
    },
    {
      ...
      description: 'Criação inteligente de produtos com extração automática de especificações técnicas, preços, categorias e características. Reconhece marcas, unidades de medida e categoriza produtos automaticamente.',
      icon: Package,
    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Assistentes de IA</h1>
            <p className="text-gray-600 mt-1">Inteligência artificial para automatizar suas tarefas</p>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Nossos assistentes de inteligência artificial automatizam tarefas complexas, 
            extraem dados automaticamente e criam registros completos em segundos.
          </p>
        </div>
            ...
            return (
              ...
              >
                <Card className="bg-white border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group">
                  <div className={`h-2 bg-gradient-to-r ${assistente.color}`}></div>
                  
                  <div className="p-8">
                    {/* Header */}
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center">
                        <div className={`w-12 h-12 bg-gradient-to-r ${assistente.color} rounded-xl flex items-center justify-center mr-4`}>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Nossa tecnologia de inteligência artificial foi desenvolvida especificamente 
              para o seu negócio, oferecendo precisão e eficiência incomparáveis.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Velocidade</h4>
              <p className="text-gray-600 text-sm">
                Crie registros completos em segundos, não minutos. 
                Nossa IA processa informações instantaneamente.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Precisão</h4>
              <p className="text-gray-600 text-sm">
                Extração automática e precisa de dados de documentos, 
                CNPJ, CEP e outras fontes confiáveis.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Confiabilidade</h4>
              <p className="text-gray-600 text-sm">
                Dados sempre atualizados e verificados através de 
                APIs oficiais e fontes confiáveis.
              </p>
            </div>
          </div>
        </div>
