...
import { buscarSolicitacao } from '@/services/credito';
import { SolicitacaoCredito } from '@/types/credito';
import StatusBadge from '@/components/credito/StatusBadge';
import TimelineCredito from '@/components/credito/TimelineCredito';
...
export default function SolicitacaoDetalhePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      {/* Header */}
      <div className="mb-6">
        <Link href="/credito/minhas-solicitacoes" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4">
