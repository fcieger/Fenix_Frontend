...
import { buscarExtrato } from '@/services/credito';
import { MovimentacaoCapitalGiro } from '@/types/credito';
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="mb-6 print:mb-4">
        <Link href="/credito/capital-giro" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4 print:hidden">
