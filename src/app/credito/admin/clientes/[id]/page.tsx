...
export default function AdminClienteDetalhePage() {
  ...
  const carregarDados = async () => {
    try {
      setLoading(true);
      const response = await api.get(`/credito/admin/clientes/${empresaId}`);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-6">
        <Link href="/credito/admin/clientes" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4">
