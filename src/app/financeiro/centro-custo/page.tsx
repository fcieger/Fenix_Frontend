...
import { Target, Plus, Download, Search, Filter } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">Gestão de centros de custo</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6">
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">Centros de custo serão implementados aqui</p>
            </div>
          </div>
        </div>
      </div>
