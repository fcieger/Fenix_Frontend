...
export default function BancoPage() {
  ...
  const { contas, loading: contasLoading, error: contasError, refreshContas, deleteConta, updateConta } = useFinancialAccounts(activeCompanyId || '');
                ...
                <div>
                          ...
                          <div className="flex gap-2 pt-4 border-t border-slate-200">
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => window.open(`/financial/banco/lancamentos/${conta.id}?nome=${encodeURIComponent(conta.descricao)}`, '_blank')}
