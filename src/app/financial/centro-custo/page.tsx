...
import { CostCenter, CreateCostCenterRequest, UpdateCostCenterRequest } from '@/types/cost-center';
import type { CentroCusto, CreateCentroCustoRequest, UpdateCentroCustoRequest } from '@/types/centro-custo';
import { ListaCentrosCustos } from '@/components/cost-centers/ListaCentrosCustos';
import { ModalCentroCusto } from '@/components/cost-centers/ModalCentroCusto';
...
export default function CentroCustosPage() {
  ...
  const handleSaveCentro = async (data: CreateCostCenterRequest | UpdateCostCenterRequest) => {
    try {
      if (centroEditando) {
        // Editar
          await updateCentro(centroEditando.id, data as UpdateCostCenterRequest);
