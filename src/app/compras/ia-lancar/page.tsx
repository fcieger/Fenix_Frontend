...
import ImageUploadZone from '@/components/compras/ImageUploadZone';
import OCRProcessing from '@/components/compras/OCRProcessing';
import NFDataReview from '@/components/compras/NFDataReview';
    ...
    try {
      ...
      if (!result.success) {
        ...
        if (result.needsUserInput) {
          ...
          // TODO: Adicionar interface de seleção de fornecedor/produtos
                ...
                {step === 'success' && processingResult && (
                  ...
                  >
                    ...
                    >
                      ...
                      <Button
                        size="lg"
                        onClick={() => router.push(`/compras/${createdPedidoId}`)}
