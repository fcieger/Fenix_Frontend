      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Entre em contato conosco e descubra como o FENIX pode transformar sua gestão empresarial.
          </p>
        </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                ...
                para sua empresa. Entre em contato e vamos começar essa jornada juntos.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-gray-600">contato@fenix.com.br</p>
                </div>
              </motion.div>
              ...
              <div className="flex gap-4">
                {["LinkedIn", "Twitter", "Instagram", "YouTube"].map((social) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 hover:text-white transition-all duration-300"
                  >
                    {social[0]}
                  </motion.button>
                ))}
