              ...
              <div className="sticky top-0 bg-gradient-to-r from-purple-600 to-purple-700 text-white p-6 rounded-t-2xl flex items-center justify-between z-10">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100 text-sm">Converta este orçamento em um pedido de compra</p>
                  </div>
                </div>
                <button
                  onClick={handleCancel}
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-900">
                          {(orcamento as any).fornecedor?.nomeRazaoSocial || 
                           (orcamento as any).fornecedor?.nome || 
                           (orcamento as any).fornecedor?.razaoSocial ||
                           'Não informado'}
                        </p>
                      </div>
                      <div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      Você pode ajustar algumas informações antes de gerar o pedido de compra
                    </p>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {/* Data de Emissão */}
