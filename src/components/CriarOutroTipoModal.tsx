        ...
        <div className="p-4 sm:p-6 h-full flex flex-col max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-3 sm:mb-4 flex-shrink-0">
            <div className="flex items-center flex-1 min-w-0">
              <div className="p-1.5 sm:p-2 bg-gradient-to-br from-orange-100 to-orange-200 rounded-lg mr-2 sm:mr-3 flex-shrink-0">
                <Plus className="h-4 w-4 sm:h-5 sm:w-5 text-orange-600" />
              </div>
              <div className="min-w-0 flex-1">
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 truncate">
                  Criar Outro Tipo de Conta
                </h3>
                <p className="text-gray-600 text-xs sm:text-sm truncate">
                  Passo {step} de 3 - Configure sua conta personalizada
                </p>
              </div>
            </div>
            <button
              ...
              {[1, 2, 3].map((stepNumber) => (
                <div key={stepNumber} className="flex items-center">
                  <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold shadow-lg transition-all duration-300 ${
                    step >= stepNumber 
                      ? 'bg-gradient-to-r from-orange-600 to-orange-700 text-white shadow-orange-200' 
                  ...
                  {stepNumber < 3 && (
                    <div className={`w-8 sm:w-16 h-1 sm:h-1.5 mx-2 sm:mx-3 rounded-full transition-all duration-300 ${
                      step > stepNumber ? 'bg-gradient-to-r from-orange-600 to-orange-700' : 'bg-gray-200'
                    }`} />
                  )}
                </div>
              ))}
          ...
          {/* Step 1: Descrição da Conta */}
          {step === 1 && (
            <div className="bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 rounded-2xl sm:rounded-3xl p-2 sm:p-3 lg:p-4 flex-1 overflow-y-auto">
              {/* Header Moderno */}
              <div className="text-center mb-2 sm:mb-3">
                <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-orange-500 to-amber-600 rounded-lg shadow-lg mb-1 sm:mb-2">
                  <Plus className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                </div>
                <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-1">Configure sua Conta Personalizada</h3>
                <p className="text-gray-600 max-w-2xl mx-auto text-xs">
                  Preencha as informações básicas da sua conta personalizada para começar o controle
                </p>
              </div>

              {/* Card de Informação */}
              <div className="bg-gradient-to-r from-orange-500 to-amber-600 rounded-lg p-2 mb-2 shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-orange-100 text-xs leading-tight">
                      Certifique-se de que os dados estão corretos para identificar sua conta personalizada.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      placeholder="Ex: Conta Especial, Fundo Reserva, etc."
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs text-amber-800 font-medium">
                      💡 Dica: Use nomes descritivos que facilitem a identificação da conta.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {step === 2 && (
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl sm:rounded-3xl p-2 sm:p-3 lg:p-4 flex-1 overflow-y-auto">
              ...
              <div className="text-center mb-2 sm:mb-3">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-xs">
                  Defina a data e o valor da conta para começar o controle
                </p>
              </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-blue-100 text-xs leading-tight">
                      Informe o valor atual da conta para manter a precisão financeira.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-1">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-600">Quando começou a usar esta conta?</p>
                    </div>
                  </div>
                ...
                <div className="space-y-1">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-600">Qual é o valor atual da conta?</p>
                    </div>
                  </div>
              ...
              <div className="mt-2 sm:mt-3 p-2 bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg border border-amber-200">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs text-amber-800 font-medium">
                      💡 Dica: Consulte seus registros para obter o valor exato da conta.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {step === 3 && (
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl sm:rounded-3xl p-2 sm:p-3 lg:p-4 flex-1 overflow-y-auto">
              <div className="text-center mb-2 sm:mb-3">
                ...
                <h4 className="text-sm sm:text-base font-bold text-gray-900 mb-1">Resumo da Conta Personalizada</h4>
          ...
          <div className="fixed bottom-4 sm:bottom-6 left-1/2 transform -translate-x-1/2 z-30 flex items-center space-x-2 sm:space-x-4 px-4">
            ...
            {step < 3 ? (
              <Button
                ...
                className="px-3 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white disabled:opacity-50 disabled:cursor-not-allowed flex items-center shadow-lg hover:shadow-xl transition-all duration-200 text-xs sm:text-sm"
              >
                Avançar
