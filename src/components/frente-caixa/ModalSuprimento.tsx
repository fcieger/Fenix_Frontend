...
import { ArrowUp, Loader2, DollarSign, FileText } from 'lucide-react';
import { useToast } from '@/components/ui/toast';

interface ModalSuprimentoProps {
  open: boolean;
...
export function ModalSuprimento({
  open,
  onOpenChange,
  caixaId,
  companyId,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!response.ok || !data.success) {
        throw new Error(data.error || 'Erro ao registrar suprimento');
      }

      success('Suprimento registrado com sucesso!');
      ...
      showError(err.message || 'Erro ao registrar suprimento');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="0,00"
                className="pl-10 text-lg h-12 border-2 focus:border-green-500"
                disabled={loading}
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Textarea
                ...
                placeholder="Ex: Reforço de troco, entrada de capital..."
                rows={4}
                className="pl-10 border-2 focus:border-green-500 resize-none"
                disabled={loading}
              />
            </div>
            <p className="text-sm text-gray-500">
              Informe o motivo da entrada para controle interno
            </p>
          </div>
