    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            Gerencie produtos, clientes, vendas e muito mais com inteligência
            artificial integrada. Simples, poderoso e acessível.
          </motion.p>
          ...
          >
            {isAuthenticated ? (
              <Button
                size="lg"
                className="text-lg px-8 py-4 h-auto group bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white"
                onClick={() => router.push("/dashboard")}
              >
                <LayoutDashboard className="mr-2 w-5 h-5 group-hover:scale-110 transition-transform" />
                Acessar Plataforma
