...
export default function CriarContaModal({ isOpen, onClose, onVoltarParaSelecao, tipoConta }: CriarContaModalProps) {
  ...
  const getIconForTipoConta = (type: string) => {
    switch (type) {
      case 'conta-corrente': return <Building2 className="h-8 w-8 text-blue-600" />;
      case 'caixinha': return <DollarSign className="h-8 w-8 text-green-600" />;
      case 'cartao-credito': return <CreditCard className="h-8 w-8 text-red-600" />;
      case 'poupanca': return <PiggyBank className="h-8 w-8 text-purple-600" />;
      case 'investimento': return <TrendingUp className="h-8 w-8 text-yellow-600" />;
      case 'aplicacao-automatica': return <Building className="h-8 w-8 text-indigo-600" />;
      case 'outras-contas-recebimento': return <Building2 className="h-8 w-8 text-green-600" />;
      default: return <HelpCircle className="h-8 w-8 text-orange-600" />;
    }
  };

  const getTipoContaLabel = (type: string) => {
    switch (type) {
      ...
      case 'aplicacao-automatica': return 'Aplicação Automática';
      case 'outras-contas-recebimento': return 'Outras Contas de Recebimento';
      default: return 'Outro Tipo de Conta';
    }
  };
    ...
    <div className="fixed inset-0 bg-white bg-opacity-95 overflow-y-auto h-full w-full z-20">
      ...
      >
        <div className="p-4 sm:p-6 h-full flex flex-col max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-3 sm:mb-4 flex-shrink-0">
              <div className="flex items-center flex-1 min-w-0">
                <div className="p-1.5 sm:p-2 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg mr-2 sm:mr-3 flex-shrink-0">
                  {getIconForTipoConta(tipoConta)}
                </div>
                <div className="min-w-0 flex-1">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 truncate">
                    Criar {getTipoContaLabel(tipoConta)}
                  </h3>
                  <p className="text-gray-600 text-xs sm:text-sm truncate">
                    Passo {step} de 3 - Preencha as informações para criar sua nova conta
                  </p>
                </div>
              </div>
              <button
          ...
          {step === 1 && (
            <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 rounded-2xl sm:rounded-3xl p-2 sm:p-3 lg:p-4 flex-1 overflow-y-auto">
              {/* Header Moderno */}
              <div className="text-center mb-2 sm:mb-3">
                <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg shadow-lg mb-1 sm:mb-2">
                  <Building2 className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                </div>
                <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-1">Configure os Dados da Conta</h3>
                <p className="text-gray-600 max-w-2xl mx-auto text-xs">
                  Preencha as informações básicas da sua conta bancária para começar o controle financeiro
                </p>
              </div>

              {/* Card de Informação */}
              <div className="bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg p-2 mb-2 shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-purple-100 text-xs leading-tight">
                      Certifique-se de que os dados estão corretos para identificar sua conta.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-2 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-lg p-2">
                <div className="flex items-center space-x-2">
                  <div className="flex-shrink-0">
                    <div className="w-5 h-5 bg-gradient-to-br from-emerald-400 to-teal-500 rounded flex items-center justify-center">
                      <Shield className="h-3 w-3 text-white" />
                    </div>
                  </div>
                  <div className="min-w-0 flex-1">
                    <h5 className="font-bold text-emerald-900 text-xs">Segurança dos Dados</h5>
          ...
          {step === 2 && (
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl sm:rounded-3xl p-2 sm:p-3 lg:p-4 flex-1 overflow-y-auto">
              ...
              <div className="text-center mb-2 sm:mb-3">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-xs">
                  Defina a data e o valor do saldo para começar o controle financeiro da sua conta
                </p>
              </div>
              ...
              {/* Card de Dica Adicional */}
              <div className="mt-2 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-lg p-2">
                <div className="flex items-center space-x-2">
                  <div className="flex-shrink-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <h5 className="font-bold text-amber-900 text-xs">Dica Pro</h5>
                    <p className="text-amber-800 text-xs">
                      Consulte o extrato bancário para obter o saldo exato.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {step === 3 && (
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl sm:rounded-3xl p-2 sm:p-3 lg:p-4 flex-1 overflow-y-auto">
              <div className="text-center mb-2 sm:mb-3">
                ...
                <h4 className="text-sm sm:text-base font-bold text-gray-900 mb-1">Resumo da Nova Conta</h4>
