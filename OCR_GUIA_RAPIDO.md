# 🚀 GUIA RÁPIDO - OCR DE NOTAS FISCAIS
...
### Cenário: Nota Fiscal de Compra de Café
...
PRODUTOS:
001 | Café Pilão 500g  | 10 UN | 12,50 | 125,00
002 | Açúcar União 1kg |  5 UN |  4,20 |  21,00
...
```
🔍 OCR extrai texto...
   └─ Texto reconhecido com 87% de confiança
...
├────────────────────────────────────────┤
│ 📄 Nota Fiscal                         │
│ NF: 12345  Série: 1  Data: 10/11/2025  │
│ Valor: R$ 146,00                       │
├────────────────────────────────────────┤
│ 🛒 Produtos (2)                        │
│ ┌──────────────────────────────────┐  │
│ │ Café Pilão 500g   | 10 | R$ 125,00│  │
│ │ Açúcar União 1kg  |  5 | R$ 21,00 │  │
│ └──────────────────────────────────┘  │
├────────────────────────────────────────┤
│ 🟢 Confiança: 92%                      │
│                                         │
...
1. Buscando fornecedor por CNPJ...
   ✗ Não encontrado
   ✅ Criando novo fornecedor: Distribuidora ABC Ltda

2. Buscando produto: Café Pilão 500g
   ✗ Não encontrado
   ✅ Criando novo produto (código: 001)

3. Buscando produto: Açúcar União 1kg
   ✓ Encontrado! (similaridade: 92%)

4. Gerando pedido de compra...
   ✅ Pedido PC-12345 criado!

🎉 SUCESSO!

┌────────────────────────────────────────┐
│ 📦 Fornecedor                          │
│ Distribuidora ABC Ltda [NOVO]          │
├────────────────────────────────────────┤
│ 🛒 Produtos (2)                        │
│ • Café Pilão 500g [NOVO]               │
│ • Açúcar União 1kg                     │
├────────────────────────────────────────┤
...
**Sistema 100% funcional e aguardando testes!**

### Próximo Passo:
```bash
npm run dev
# Acesse: http://localhost:3004/compras/ia-lancar
# Tire foto de nota fiscal
